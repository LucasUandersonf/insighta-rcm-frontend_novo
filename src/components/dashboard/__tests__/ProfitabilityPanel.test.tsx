...
describe("ProfitabilityPanel", () => {
  it("lista rentabilidade por profissional e mix por procedimento", async () => {
    const data: Profitability = {
      ...
      total_billed: 1000,
      by_professional: [
        { professional_id: "p1", full_name: "Dr. Rentável", revenue: 300, booked_minutes: 60, revenue_per_hour: 300 },
        { professional_id: "p2", full_name: "Dra. Sem Agenda", revenue: 100, booked_minutes: 0, revenue_per_hour: null },
      ],
      by_procedure: [
