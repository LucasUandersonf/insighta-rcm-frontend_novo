 ...
 *
 * DECISÃO — silencioso quando não há narrativa, nunca um card de erro
 * -------------------------------------------------------------------
 * `narrative: null` cobre tanto "IA não configurada" quanto "geração
 * falhou hoje" (o backend já decide isso, ver DECISÃO lá) — dos dois
 * lados, o tratamento aqui é o MESMO: não renderiza nada. Esta é uma
 * peça de abertura substantiva, mas não crítica — um erro de rede aqui
 * nunca deveria virar um alerta vermelho na primeira coisa que o gestor
 * vê ao abrir a tela.
 */
