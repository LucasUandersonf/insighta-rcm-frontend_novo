...
export function PriorityQueuePanel({
  ...
  const { canManage, assigningItem, setAssigningItem, actionedKeys, setActionedKeys, resolveMutation } = useInsightWorkflow();
  ...
  return (
    ...
    >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className={cn("mt-2 flex flex-wrap items-center gap-3")}>
                    ...
                    <InsightWorkflowButtons
                      ...
                      canManage={canManage}
                      actioned={actioned}
                      onResolve={(i) => resolveMutation.mutate(i)}
      ...
      <AssignModal
        ...
        onAssigned={(item) => setActionedKeys((prev) => ({ ...prev, [insightItemKey(item)]: "atribuido" }))}
      />
    </Panel>
  );
}
